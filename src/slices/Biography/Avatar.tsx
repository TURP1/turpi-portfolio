        ...
        <div ref={component} className={clsx('relative h-full w-full', className)}>
            <div className="avatar aspect-square overflow-hidden rounded-3xl border-2 border-slate-700 opacity-0">
                ...
                <PrismicNextImage
                    ...
                    imgixParams={{q: 90}}/> {/* smth like Cloudinary*/}

                <div
                    className="highlight absolute inset-0 hidden w-full scale-110 bg-gradient-to-tr from-transparent via-white to-transparent opacity-0 md:block"></div>
            </div>
        </div>
    )
}
